        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 space-y-8">
            ...
            @empty
                <div class="bg-white p-12 text-center shadow-sm sm:rounded-lg">
                    <svg class="mx-auto text-gray-400" style="height: 3rem; width: 3rem; margin-left: auto; margin-right: auto;" fill="none" viewBox="0 0 24 24" stroke="currentColor" aria-hidden="true">
